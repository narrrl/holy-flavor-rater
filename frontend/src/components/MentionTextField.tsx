...
const MentionTextField: React.FC<MentionTextFieldProps> = ({
    ...
    return (
        <Box sx={{ position: 'relative', width: fullWidth ? '100%' : 'auto' }}>
            ...
            >
                <Paper elevation={8} sx={{ mt: 1, borderRadius: 2, overflow: 'hidden', border: '1px solid', borderColor: 'divider' }}>
                        ...
                        {suggestions.map((user, index) => (
                            ...
                            >
                                <ListItemAvatar sx={{ minWidth: 40 }}>
                                    <Avatar src={user.avatar || undefined} sx={{ width: 28, height: 28, fontSize: '0.8rem' }}>
