  ...
  en: {
    translation: {
      ...
      "about": {
        ...
        "featurePersonalize": "Personalize: Choose from over 15 themes and select interactive banners to make the archive your own.",
        "featureEngage": "Engage: Start discussions by replying to reviews and leaving comments on user profiles.",
        "featureSupport": "Support: Get direct assistance through our integrated ticket system for any questions or issues.",
      ...
      "privacy": {
        ...
        "intro": "Protecting your personal data is a top priority for us. Below we inform you about the processing of your data on our website in accordance with the requirements of the GDPR.",
        ...
        "regDesc": "When you create an account, we store your username, email address, and password (encrypted). This data is used to provide community features (ratings, following users). The legal basis is Art. 6 Para. 1 lit. b GDPR.",
        "ipTitle": "IP Addresses:",
        "ipDesc": "To ensure the security of our IT systems and to prevent abuse, we store the IP addresses from which you log in. This data is deleted as soon as it is no longer necessary to achieve the purpose for which it was collected. The legal basis is Art. 6 Para. 1 lit. f GDPR.",
        "profileTitle": "Public Profile:",
        "profileDesc": "Your username, avatar, ratings, and profile comments are publicly visible to other users. You can change or delete your profile data at any time in your settings.",
        "socialTitle": "Social Interaction:",
        "socialDesc": "Comments left on profiles and replies to ratings are stored and displayed publicly. This includes the timestamp and the author of the content.",
        "supportTitle": "Support Tickets:",
        "supportDesc": "When you open a support ticket, we store the subject, description, and subsequent messages to provide technical assistance and resolve your inquiry.",
        "personalizationTitle": "Personalization:",
        "personalizationDesc": "Your preferred theme, language, and selected interactive banner are stored in your user profile to provide a consistent experience across sessions.",
        "deletionTitle": "Account Deletion:",
        "deletionDesc": "You can permanently delete your account and all associated personal data at any time in your account settings. For security reasons, this requires verification via an email code.",
        "transferTitle": "3. Data Transfer to Third Parties",
        "transferDesc": "We do not pass your data on to third parties without your express consent, unless this is necessary to fulfill a contract or a legal obligation.",
        "rightsTitle": "4. Your Rights",
        "rightsDesc": "You have the right to information (Art. 15 GDPR), correction (Art. 16 GDPR), deletion (Art. 17 GDPR), and restriction of the processing of your data. Please contact us at:"
      },
      "cookieBanner": {
  ...
  de: {
    translation: {
      ...
      "about": {
        ...
        "featurePersonalize": "Personalisieren: Wähle aus über 15 Designs und interaktiven Bannern, um das Archiv nach deinen Wünschen zu gestalten.",
        "featureEngage": "Interagieren: Starte Diskussionen durch Antworten auf Rezensionen und Kommentare auf Profilen.",
        "featureSupport": "Support: Erhalte direkte Hilfe über unser integriertes Ticketsystem bei Fragen oder Problemen.",
      ...
      "privacy": {
        ...
        "intro": "Der Schutz Ihrer persönlichen Daten ist uns ein wichtiges Anliegen. Nachfolgend informieren wir Sie über die Verarbeitung Ihrer Daten auf unserer Webseite gemäß den Anforderungen der DSGVO.",
        ...
        "regDesc": "Wenn Sie ein Konto erstellen, speichern wir Ihren Benutzernamen, Ihre E-Mail-Adresse und Ihr Passwort (verschlüsselt). Diese Daten werden zur Bereitstellung der Community-Funktionen verwendet. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO.",
        "ipTitle": "IP-Adressen:",
        "ipDesc": "Zur Gewährleistung der Sicherheit unserer IT-Systeme und zur Missbrauchsverhinderung speichern wir die IP-Adressen, von denen aus Sie sich anmelden. Diese Daten werden gelöscht, sobald sie nicht mehr erforderlich sind. Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO.",
        "profileTitle": "Öffentliches Profil:",
        "profileDesc": "Ihr Benutzername, Ihr Avatar, Ihre Bewertungen und Ihre Profilkommentare sind für andere Nutzer öffentlich sichtbar. Sie können diese jederzeit in den Einstellungen ändern oder löschen.",
        "socialTitle": "Soziale Interaktion:",
        "socialDesc": "Kommentare auf Profilen und Antworten auf Bewertungen werden dauerhaft gespeichert und öffentlich angezeigt. Dies beinhaltet den Zeitpunkt der Erstellung und den Autor.",
        "supportTitle": "Support-Tickets:",
        "supportDesc": "Wenn Sie ein Support-Ticket eröffnen, speichern wir den Betreff, die Beschreibung sowie die folgenden Nachrichten, um technische Hilfe zu leisten und Ihre Anfrage zu bearbeiten.",
        "personalizationTitle": "Personalisierung:",
        "personalizationDesc": "Ihr bevorzugtes Design, Ihre Sprache und Ihr ausgewählter interaktiver Banner werden in Ihrem Profil gespeichert, um ein konsistentes Erlebnis über verschiedene Sitzungen hinweg zu bieten.",
        "deletionTitle": "Kontolöschung:",
        "deletionDesc": "Sie können Ihr Konto und alle damit verbundenen personenbezogenen Daten jederzeit in den Einstellungen dauerhaft löschen. Zur Sicherheit ist hierfür eine Verifizierung per E-Mail-Code erforderlich.",
        "transferTitle": "3. Datenübermittlung an Dritte",
        "transferDesc": "Wir geben Ihre Daten nicht ohne Ihre ausdrückliche Einwilligung an Dritte weiter, es sei denn, dies ist zur Vertragserfüllung oder zur Erfüllung gesetzlicher Verpflichtungen erforderlich.",
        "rightsTitle": "4. Ihre Rechte",
        "rightsDesc": "Sie haben das Recht auf Auskunft (Art. 15 DSGVO), Berichtigung (Art. 16 DSGVO), Löschung (Art. 17 DSGVO) und Einschränkung der Verarbeitung Ihrer Daten. Bitte kontaktieren Sie uns unter:"
      },
      "cookieBanner": {
