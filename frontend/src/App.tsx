...
const CategoryFlavors = lazy(
  () => import("./pages/categories/CategoryFlavors"),
);
    ...
    const timer = setTimeout(async () => {
      ...
      try {
        const res = await api.get(
          `flavors/search/?q=${encodeURIComponent(query)}`,
        );
    ...
    <Box sx={{ flexGrow: 1, mx: isMobile ? 1 : 4 }}>
      <Autocomplete
        ...
        onInputChange={(_, newValue) =>
          setQuery(typeof newValue === "string" ? newValue : "")
        }
        onChange={(_, newValue) => {
...
const App: React.FC = () => {
      ...
      try {
        ...
        if (userRes.data && userRes.data.username) {
          ...
          try {
            ...
            const followData = Array.isArray(followRes.data)
              ? followRes.data
  ...
  const notificationsMenu = (
    <>
      ...
      >
        <Badge
          badgeContent={user?.unread_notifications_count || 0}
          color="error"
        >
          <NotificationsIcon />
        </Badge>
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      >
        ...
        >
          <Toolbar
            sx={{ minHeight: { xs: 56, sm: 64 }, px: { xs: 1, sm: 4, md: 6 } }}
          >
            <Typography
              variant="h6"
              component="div"
                      ...
                      >
                        ...
                        {user.is_superuser && (
                          <MenuItem
                            ...
                            sx={{
                              color: adminMode ? "primary.main" : "inherit",
                            }}
                          >
        ...
        <Box sx={{ flexGrow: 1, width: "100%" }}>
          ...
          >
            <Routes>
              ...
              <Route
                path="/flavor/:id"
                element={<FlavorDetail adminMode={adminMode} />}
              />
              <Route
                path="/profile/:username"
                element={<PublicProfile adminMode={adminMode} />}
              />
              <Route
                path="/community"
                element={<CommunityFeed adminMode={adminMode} />}
              />
              ...
              />
              <Route
                path="/admin-panel/rating/:id"
                element={<AdminRatingDetail />}
              />
              <Route
                path="/admin-panel/reply/:id"
                element={<AdminReplyDetail />}
              />
