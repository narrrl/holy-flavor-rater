...
const Settings: React.FC<SettingsProps> = ({ themeName, onThemeChange }) => {
  ...
  const handleUpdateProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.data.message) {
        ...
        setMessage({
          type: "success",
          text: `${t("settings.updateSuccess")} ${res.data.message}`,
        });
      } else {
  ...
  const handleConfirmEmail = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const res = await api.post("users/confirm_email/", {
      ...
      setMessage({
        type: "error",
        text: err.response?.data?.error || "Confirmation failed",
      });
    }
  };
          ...
          >
            ...
            <FormControl fullWidth margin="normal">
              ...
              <Select
                ...
                onChange={(e) =>
                  onThemeChange(e.target.value as CatppuccinTheme)
                }
              >
            ...
            <FormControl fullWidth margin="normal">
              ...
              <Select
                ...
                onChange={async (e) => {
                  ...
                  try {
                    await api.patch("users/update_preferences/", {
                      selected_banner: newId,
                    });
                  } catch (err) {
          ...
          >
            ...
            <form onSubmit={handleUpdateProfile}>
              ...
              <TextField
                ...
                helperText={
                  email !== currentEmail ? t("settings.emailHint") : ""
                }
                InputLabelProps={{ shrink: true }}
              />
              <Button
