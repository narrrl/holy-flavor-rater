...
import { Typography, Box, Container, Paper, Button, ToggleButton, ToggleButtonGroup } from '@mui/material';
  ...
  return (
    <Container maxWidth="md" sx={{ py: 8 }}>
      ...
      <Paper sx={{ p: { xs: 3, md: 6 }, borderRadius: 4 }}>
        {lang === 'de' ? (
            <Box>
                <Typography variant="h3" gutterBottom sx={{ fontWeight: 'bold' }}>Datenschutzerklärung</Typography>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>1. Verantwortlicher</Typography>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>2. Erfassung und Speicherung personenbezogener Daten</Typography>
                <Typography variant="body2" paragraph>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>3. Datenübermittlung an Dritte</Typography>
                <Typography variant="body2" paragraph>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>4. Ihre Rechte</Typography>
                <Typography variant="body2" paragraph>
            ...
            <Box>
                <Typography variant="h3" gutterBottom sx={{ fontWeight: 'bold' }}>Privacy Policy</Typography>
                <Typography variant="body1" paragraph>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>1. Controller</Typography>
                <Typography variant="body2" paragraph>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>2. Collection and Storage of Personal Data</Typography>
                <Typography variant="body2" paragraph>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>3. Data Transfer to Third Parties</Typography>
                <Typography variant="body2" paragraph>
                ...
                <Typography variant="h5" gutterBottom sx={{ mt: 4, fontWeight: 'bold' }}>4. Your Rights</Typography>
                <Typography variant="body2" paragraph>
