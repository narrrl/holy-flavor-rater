...
const AdminDashboard: React.FC = () => {
  ...
  const fetchData = async (silent = false) => {
    ...
    try {
      const [statsRes, usersRes, bannersRes, jobsRes, configRes] =
        await Promise.all([
                  ...
                  >
                    <Box>
                      ...
                      >
                        ...
                        TLS: {String(stats?.email_config.use_tls)} • Insecure:{" "}
                ...
                <Stack spacing={2.5}>
                  ...
                  >
                    ...
                    <Typography variant="caption" color="text.secondary">
                      These values are read from your server environment or .env
                      file. To change them, you must update the file and restart
