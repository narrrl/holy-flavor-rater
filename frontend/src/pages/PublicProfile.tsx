...
const PublicProfile: React.FC<PublicProfileProps> = ({ adminMode }) => {
  ...
  const currentRatings =
    categoryTab === 0
      ? data.ratings
      : categoryGroups[ratingCategories[categoryTab]];
            ...
            >
              {currentUser?.username !== data.username && (
                <Button
                  ...
                  startIcon={
                    data.is_following ? <PersonRemoveIcon /> : <PersonAddIcon />
                  }
                  sx={{
                    borderRadius: 1,
                    px: 4,
              ...
              {data.comments.length === 0 ? (
                ...
                >
                  <Typography
                    ...
                    sx={{ fontWeight: "bold" }}
                  >
                    No entries in the guestbook yet.
                  </Typography>
            ...
            {data.followers.length === 0 ? (
              <Grid size={12}>
                <Typography
                  variant="h6"
                  color="text.secondary"
                  sx={{ py: 12, textAlign: "center", fontWeight: "bold" }}
                >
                  No followers yet.
                </Typography>
              </Grid>
